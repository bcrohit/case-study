...
\begin{frame}{}
    \vspace{0.5cm}
    {\raggedright
        {\fontsize{16}{20}\selectfont \color{tugreen} Key Results — Random Forest BP Analysis}
    }
    \vspace{0.5cm}
    {
    \setbeamercolor{item}{fg=tugreen}
    \begin{itemize}
        \item \textbf{Age is the strongest predictor:} 0.67
        \item \textbf{Other factors:} Gender, Diabetes, Smoking, Cholesterol have low influence
        \item \textbf{Performance:} Weak overall (Systolic R² = 0.12, Diastolic R² = 0.02)
        \item \textbf{Conclusion:} Age matters most; lifestyle factors less predictive; prediction errors clinically significant
    \end{itemize}
    }
\end{frame}